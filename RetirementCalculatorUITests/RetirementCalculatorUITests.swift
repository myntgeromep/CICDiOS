...
//
//  Created by Gerome Pagatpatan on 2/11/22.
//
...
class RetirementCalculatorUITests: XCTestCase {
    ...
    func testExample() {
        ...
        XCTContext.runActivity(named: "screenshot") { (activity) in
            ...
            let result = "If you save $100.0 every month for 35 years, and invest that money plus your current investment of $1000.0 at a 3.0% annual interest rate, you will have $246467878.4603446 by the time you are 65"
